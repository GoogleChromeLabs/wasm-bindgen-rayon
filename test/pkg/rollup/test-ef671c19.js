import { startWorkers } from './workerHelpers-aa2caa52.js';
...
async function init(input, maybe_memory) {
    if (typeof input === 'undefined') {
        input = new URL("assets/test_bg-fdccd79f.wasm", import.meta.url);
    }
    const imports = getImports();
...
export { init as default, initSync, initThreadPool, sum, wbg_rayon_PoolBuilder, wbg_rayon_start_worker };
